...
class OBISEnergyReaderStaticSensor(SensorEntity):
    ...
    def __init__(
        ...
        if key in [
            OBISSensorKey.TOTAL_ACTIVE_ENERGY_CONSUMED_IMPORT,
            OBISSensorKey.TOTAL_ACTIVE_ENERGY_EXPORTED_EXPORT,
        ]:
            self._attr_device_class = SensorDeviceClass.ENERGY
            self._attr_state_class = SensorStateClass.TOTAL_INCREASING
        elif key in [
            OBISSensorKey.INSTANTANEOUS_ACTIVE_POWER_EXPORT,
            OBISSensorKey.INSTANTANEOUS_ACTIVE_POWER_EXPORT,
            OBISSensorKey.INSTANTANEOUS_TOTAL_ACTIVE_POWER,
        ]:
